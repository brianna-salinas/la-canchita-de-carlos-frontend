    ...
    >
      <div className="flex flex-col items-center text-center mb-6">
        <img
          ...
          className="h-28 w-28 rounded-full object-cover border-2 border-brand-secondary shadow-sm"
        />
        <h1 className="font-display font-bold text-4xl mt-4 leading-none">
      ...
      {/* Card / marco que envuelve todo el formulario */}
